      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div className="px-6 py-3 bg-gray-50 flex justify-end">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={`inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-white ${typeStyles.confirmButton} focus:outline-hidden focus:ring-2 focus:ring-offset-2`}
          >
            {confirmText}
          </button>
        </div>
