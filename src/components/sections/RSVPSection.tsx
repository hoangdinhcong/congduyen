...
import { FaCheck, FaTimes, FaHeart, FaEnvelope, FaReply } from 'react-icons/fa';
    ...
    <>
      ...
      {showFloatingButton && (
        <button 
          ...
          className="fixed bottom-6 right-6 bg-primary hover:bg-primary-dark text-white rounded-full p-4 shadow-lg z-50 transition-all duration-300 transform hover:scale-110"
