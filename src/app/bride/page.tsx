    ...
    <MainLayout>
      <div className="py-8 bg-primary-light">
        <div className="container-wedding">
          <SectionTitle 
            title="Bride&apos;s Side" 
            subtitle="Welcome to Duyen&apos;s family and friends"
          />
          
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg mb-4">
              Thank you for being part of Duyen&apos;s journey. We&apos;re excited to have you join us for this special celebration.
            </p>
